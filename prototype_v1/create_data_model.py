...
class TrainingDataset:
    ...
    def __init__(self, IMG_SAVE_PATH, CLASS_MAP, NUM_CLASSES):
...
def main():
    ...
    TrainingDataset(IMG_SAVE_PATH, CLASS_MAP, NUM_CLASSES)
    ...
    labels = list(map(TrainingDataset.mapper, labels))
    ...
    # define the model
    model = TrainingDataset.get_model()
    model.compile(
